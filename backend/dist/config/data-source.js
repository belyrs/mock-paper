...
const _1724832000000_scope_question_hash_uniqueness_1 = require("../migrations/1724832000000-scope-question-hash-uniqueness");
const buildDataSource = () => new typeorm_1.DataSource({
    ...
    entities: [
        ...
        historical_paper_entity_1.HistoricalPaper,
        historical_question_entity_1.HistoricalQuestion,
    ],
    migrations: [
        _1724496000000_init_schema_1.InitSchema1724496000000,
        _1724668800000_add_structural_fingerprint_columns_1.AddStructuralFingerprintColumns1724668800000,
        _1724832000000_scope_question_hash_uniqueness_1.ScopeQuestionHashUniqueness1724832000000,
    ],
    migrationsRun: false,
