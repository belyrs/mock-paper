...
for (const candidate of [(0, node_path_1.resolve)(process.cwd(), ".env"), (0, node_path_1.resolve)(process.cwd(), "..", ".env")]) {
...
const envSchema = zod_1.z.object({
    ...
    DATABASE_CONNECT_RETRY_DELAY_MS: zod_1.z.coerce.number().int().positive().default(2000),
    JWT_SECRET: zod_1.z.string().min(1, "JWT_SECRET is required"),
    JWT_EXPIRES_IN: zod_1.z.string().default("8h"),
    PASSWORD_RESET_TOKEN_EXPIRES_MINUTES: zod_1.z.coerce.number().int().positive().default(30),
    ...
    QUESTION_GENERATION_MAX_ATTEMPTS: zod_1.z.coerce.number().int().positive().default(3),
