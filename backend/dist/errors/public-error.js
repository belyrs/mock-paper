...
function isPreparationError(code) {
    return (code.startsWith("OPENAI_") ||
...
function toPublicError(error) {
    if (error.code === "OPENAI_REQUEST_TIMEOUT") {
        return {
            ...
            message: "Question paper preparation is taking longer than expected. Please try again.",
            details: null,
        };
    }
...
//# sourceMappingURL=public-error.js.map