      ...
      mockQuestionTemplates: [
        {
          ...
          learningOutcome:
            "Determine the dimensions of a derived physical quantity correctly.",
          commonMistake:
            "Students often confuse force per unit area with force per unit length.",
        ...
        },
        {
          ...
          learningOutcome:
            "Identify whether a physical equation is dimensionally consistent.",
          commonMistake:
            "Students sometimes compare only one term and ignore the dimensions of every term in the equation.",
          recommendedRemedialAction:
        ...
        },
        {
          ...
          learningOutcome:
            "Recognize what dimensional analysis can and cannot determine.",
          commonMistake:
            "Students often assume that numerical coefficients like 2 or pi can be obtained from dimensions.",
          recommendedRemedialAction:
        ...
        },
        {
          ...
          learningOutcome:
            "Use dimensions to infer the form of a relation among variables.",
          commonMistake:
            "Students sometimes assign the wrong dimension to acceleration due to gravity and obtain incorrect exponents.",
          recommendedRemedialAction:
        ...
        },
        {
          ...
          learningOutcome:
            "Distinguish a valid dimensional relation from tempting but incorrect alternatives.",
          commonMistake:
            "Students often ignore that trigonometric arguments must be dimensionless.",
          recommendedRemedialAction:
        ...
        },
        {
          ...
          learningOutcome:
            "Find the dimensions of a constant from a physical law.",
          commonMistake:
            "Students often forget that the proportionality constant must balance the dimensions of all remaining variables.",
          recommendedRemedialAction:
        ...
        },
        {
          ...
          learningOutcome:
            "Convert units correctly by tracking how the dimensions scale with new base units.",
          commonMistake:
            "Students often scale only the numerical value and ignore the power of each base unit.",
          recommendedRemedialAction:
        ...
        },
        {
          ...
          conceptTested: "Dimensional formula of a derived quantity",
          learningOutcome:
            "Relate a named physical quantity to force and length or force and area to obtain its dimensions.",
          commonMistake:
            "Students often confuse surface tension with pressure and therefore divide force by area instead of length.",
          recommendedRemedialAction:
        ...
        },
        {
          ...
          learningOutcome:
            "Set up and solve simultaneous exponent equations in dimensional analysis.",
          commonMistake:
            "Students frequently miss one exponent equation and therefore obtain inconsistent powers.",
          recommendedRemedialAction:
        ...
        },
        {
          ...
          difficulty: "Hard",
          conceptTested:
            "Detecting dimensionally correct but physically incomplete statements",
          learningOutcome:
            "Separate dimensional consistency from full physical validity.",
          commonMistake:
            "Students often conclude that a dimensionally correct relation must be the final law.",
          recommendedRemedialAction:
        ...
        },
        {
          ...
          learningOutcome:
            "Determine the dimensions of a physical constant from a multi-variable relation.",
          commonMistake:
            "Students often forget that the distance term appears in the denominator with a power.",
          recommendedRemedialAction:
    ...
    mockQuestionTemplates: [
      {
        ...
        learningOutcome:
          "Use Delta U = Q - W with the correct physical sign convention.",
        commonMistake:
          "Students often add Q and W even when work is done by the system.",
        recommendedRemedialAction:
      ...
      },
      {
        ...
        commonMistake:
          "Students sometimes group internal energy with heat and work because all three appear in the first law.",
        recommendedRemedialAction:
      ...
      },
      {
        ...
        learningOutcome:
          "Calculate internal energy change from heat supplied and work done.",
        commonMistake:
          "Students often reverse the sign of work done by the system.",
        recommendedRemedialAction:
      ...
      },
      {
        ...
        learningOutcome:
          "Infer internal energy change in an adiabatic process from work done.",
        commonMistake:
          "Students sometimes forget that Q = 0 in an adiabatic process.",
        recommendedRemedialAction:
      ...
      },
      {
        ...
        learningOutcome:
          "Use the condition Delta U = 0 for a complete thermodynamic cycle.",
        commonMistake:
          "Students often think that heat and work must both be zero in a cycle.",
        recommendedRemedialAction:
      ...
      },
      {
        ...
        learningOutcome:
          "Handle sign conventions correctly when work is done on the system.",
        commonMistake:
          "Students often use the magnitude of work without updating its sign in the equation.",
        recommendedRemedialAction:
      ...
      },
      {
        ...
        learningOutcome:
          "Analyze how heat and work combine to produce the same or different internal-energy changes.",
        commonMistake:
          "Students often compare only heat or only work instead of the net effect Q - W.",
        recommendedRemedialAction:
    ...
    mockQuestionTemplates: [
      {
        ...
        learningOutcome:
          "Recall the phenotype ratio of a classic monohybrid cross.",
        commonMistake:
          "Students often confuse the phenotype ratio 3:1 with the genotype ratio 1:2:1.",
        recommendedRemedialAction:
          "Write the Punnett square explicitly and separate genotype counting from phenotype counting.",
        bloomsTaxonomyLevel: "Understanding",
        sourceReference:
          "NCERT Class 11 Biology - Principles of Inheritance and Variation",
        build: () => ({
          questionText:
      ...
      },
      {
        ...
        learningOutcome:
          "Identify the Mendelian law illustrated by separation of alleles during gamete formation.",
        commonMistake:
          "Students sometimes describe independent assortment when the stem refers to one gene pair.",
        recommendedRemedialAction:
      ...
      },
      {
        ...
        learningOutcome:
          "Use a test cross to infer the genotype of an individual showing the dominant phenotype.",
        commonMistake:
          "Students often perform a self-cross instead of crossing with a homozygous recessive parent.",
        recommendedRemedialAction:
      ...
      },
      {
        ...
        learningOutcome:
          "Predict the genotype ratio produced by a heterozygous self-cross.",
        commonMistake:
          "Students sometimes state the phenotype ratio when the question asks for genotypes.",
        recommendedRemedialAction:
      ...
      },
      {
        ...
        learningOutcome:
          "Recognize the law demonstrated by a dihybrid cross under classical Mendelian conditions.",
        commonMistake:
          "Students sometimes apply segregation only and miss that two gene pairs are assorting.",
        recommendedRemedialAction:
      ...
      },
      {
        ...
        learningOutcome:
          "Infer the parental genotype from the outcome of a diagnostic cross.",
        commonMistake:
          "Students often ignore the appearance of the recessive phenotype, which immediately rules out a homozygous dominant parent.",
        recommendedRemedialAction:
      ...
      },
      {
        ...
        learningOutcome:
          "Use Mendelian logic to distinguish whether a proposed interpretation is correct.",
        commonMistake:
          "Students sometimes think the dominant allele disappears in the recessive phenotype class.",
        recommendedRemedialAction:
      ...
      mockQuestionTemplates: [
        {
          ...
          commonMistake:
            "Students often multiply by molar mass instead of dividing by it.",
          recommendedRemedialAction:
        ...
        },
        {
          ...
          learningOutcome:
            "Relate one mole to the number of constituent particles.",
          commonMistake:
            "Students sometimes attach Avogadro's number to grams instead of moles.",
          recommendedRemedialAction:
        ...
        },
        {
          ...
          learningOutcome:
            "Identify the reagent that gets exhausted first in a balanced reaction.",
          commonMistake:
            "Students often compare reactant masses directly without converting to mole requirements from the equation.",
          recommendedRemedialAction:
        ...
        },
        {
          ...
          learningOutcome:
            "Calculate the number of molecules from a given amount in moles.",
          commonMistake:
            "Students sometimes divide by Avogadro's number instead of multiplying.",
          recommendedRemedialAction:
        ...
        },
        {
          ...
          learningOutcome:
            "Derive the empirical formula from the simplest whole-number mole ratio.",
          commonMistake:
            "Students often stop at the decimal mole ratio and forget to convert it to whole numbers.",
          recommendedRemedialAction:
        ...
        },
        {
          ...
          learningOutcome:
            "Combine mole concept with reaction stoichiometry to compute product mass.",
          commonMistake:
            "Students sometimes use the correct stoichiometric ratio but the wrong molar mass in the final conversion.",
          recommendedRemedialAction:
        ...
        },
        {
          ...
          learningOutcome:
            "Determine the molecular formula using empirical-formula mass and molar mass.",
          commonMistake:
            "Students often forget to compare the given molar mass with the empirical-formula mass.",
          recommendedRemedialAction:
      ...
      mockQuestionTemplates: [
        {
          ...
          learningOutcome:
            "Use the discriminant to identify the nature of roots.",
          commonMistake:
            "Students sometimes stop after checking that the discriminant is non-negative and forget the equal-root case.",
          recommendedRemedialAction:
        ...
        },
        {
          ...
          learningOutcome:
            "Find the sum of roots from the coefficients of a quadratic equation.",
          commonMistake:
            "Students often use the wrong denominator while applying the root relation.",
          recommendedRemedialAction:
        ...
        },
        {
          ...
          learningOutcome:
            "Form the quadratic equation corresponding to a pair of roots.",
          commonMistake:
            "Students often use the given roots directly as coefficients instead of first computing their sum and product.",
          recommendedRemedialAction:
        ...
        },
        {
          ...
          learningOutcome:
            "Decide whether the roots are real, distinct, equal or non-real based on b^2 - 4ac.",
          commonMistake:
            "Students sometimes misread a negative discriminant as irrational instead of non-real.",
          recommendedRemedialAction:
        ...
        },
        {
          ...
          learningOutcome:
            "Use the discriminant condition to determine a parameter value.",
          commonMistake:
            "Students often solve only one sign of the parameter or forget to impose b^2 - 4ac = 0 exactly.",
          recommendedRemedialAction:
        ...
        },
        {
          ...
          learningOutcome:
            "Use coefficient conditions for a quadratic whose roots are reciprocals of each other.",
          commonMistake:
            "Students often forget that reciprocal roots imply the product of roots is 1.",
          recommendedRemedialAction:
...
const entriesByKey = new Map(
  SYLLABUS_GROUNDING_ENTRIES.map((entry) => [entry.key, entry]),
);
