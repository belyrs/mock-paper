...
export class InitSchema1724496000000 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS questions_chapter_normalized_idx ON questions("chapterNormalized");`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS questions_sub_topic_normalized_idx ON questions("subTopicNormalized");`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS questions_structural_fingerprint_idx ON questions("structuralFingerprint");`,
    );
    ...
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS historical_questions_normalized_hash_idx ON historical_questions("normalizedHash");`,
    );
    await queryRunner.query(
      `CREATE INDEX IF NOT EXISTS historical_questions_structural_fingerprint_idx ON historical_questions("structuralFingerprint");`,
    );
  }
