export const PROMPT_VERSION = "2026-09-10.demo-v1";

export const BASE_PROMPT = `Act as an expert [SUBJECT] faculty member and examination paper setter for Class 11/12 competitive examinations.
